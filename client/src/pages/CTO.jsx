...
export default function CTO() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_SERVER}/get-trial-data/${input.toUpperCase()}`)
      if (!response.ok) {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_SERVER}/predict-outcome`, {
        method: "POST",
